      ...
      <section className="cart">
        <div className="container">
              ...
              <div className="block">
                ...
                <ul className="round-options round-options--three">
                  <li className="round-item">
                    <Image src="/images/logos/paypal.png" alt="Paypal" />
                  </li>
                  <li className="round-item">
                    <Image src="/images/logos/visa.png" alt="Paypal" />
                  </li>
                  <li className="round-item">
                    <Image src="/images/logos/mastercard.png" alt="Paypal" />
                  </li>
                  <li className="round-item">
                    <Image src="/images/logos/maestro.png" alt="Paypal" />
                  </li>
                  <li className="round-item">
                    <Image src="/images/logos/discover.png" alt="Paypal" />
                  </li>
                  <li className="round-item">
                    <Image src="/images/logos/ideal-logo.svg" alt="Paypal" />
                  </li>
                </ul>
              </div>
              ...
              {/* <div className="block">
                ...
                <ul className="round-options round-options--two">
                  <li className="round-item round-item--bg">
                    <Image src="/images/logos/inpost.svg" alt="Paypal" />
                    <p>$20.00</p>
                  </li>
                  <li className="round-item round-item--bg">
                    <Image src="/images/logos/dpd.svg" alt="Paypal" />
                    <p>$12.00</p>
                  </li>
                  <li className="round-item round-item--bg">
                    <Image src="/images/logos/dhl.svg" alt="Paypal" />
                    <p>$15.00</p>
                  </li>
                  <li className="round-item round-item--bg">
                    <Image src="/images/logos/maestro.png" alt="Paypal" />
          ...
          <div className="cart-actions cart-actions--checkout">
            <Link href="/cart">
            <a className="cart__btn-back"><i className="icon-left"></i> Back</a>
            </Link>
